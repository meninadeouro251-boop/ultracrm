...
help: ## Show this help message
	@echo ""
	@echo "  $(CYAN)Ultra CRM Community$(RESET) — Development Commands"
	@echo ""
...
setup: ## First-time setup: copy env, build, start, seed
	@echo "$(CYAN)Setting up Ultra CRM Community...$(RESET)"
	@if [ ! -f .env ]; then \
		cp .env.example .env; \
	...
	@echo ""
	@echo "$(GREEN)============================================$(RESET)"
	@echo "$(GREEN)  Ultra CRM Community is running!$(RESET)"
	@echo "$(GREEN)============================================$(RESET)"
	@echo ""
	...
	@echo ""
	@echo "  Login:  support@ultracrm.com"
...
logs: ## Show logs (use SERVICE=name to filter, e.g. make logs SERVICE=ultra-crm)
ifdef SERVICE
