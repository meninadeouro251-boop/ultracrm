...
Load config from `{project-root}/_ultra/bmm/config.yaml` and resolve:
...
Edit `{project-root}/_ultra/bmm/config.yaml`:
...
You can switch features anytime by running `/ultra-bmm-set-feature`."
