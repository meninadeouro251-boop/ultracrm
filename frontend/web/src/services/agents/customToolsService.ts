...
export const listCustomTools = async (params?: CustomToolsListParams): Promise<CustomTool[]> => {
  ...
  const response = await ultraaiApi.get('/custom-tools', {
    params: queryParams,
  });
