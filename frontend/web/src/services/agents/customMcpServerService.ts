...
export const listCustomMcpServers = async (
  ...
  const response = await ultraaiApi.get('/custom-mcp-servers', {
    params: queryParams,
  });
...
export const createCustomMcpServer = async (
  ...
  const response = await ultraaiApi.post('/custom-mcp-servers', server);
  return extractData<any>(response);
};

// Get custom MCP server by ID
export const getCustomMcpServer = async (serverId: string): Promise<CustomMcpServer> => {
  const response = await ultraaiApi.get(`/custom-mcp-servers/${serverId}`);
  return extractData<any>(response);
};
...
export const updateCustomMcpServer = async (
  ...
  const response = await ultraaiApi.put(`/custom-mcp-servers/${serverId}`, server);
  return extractData<any>(response);
};

// Delete custom MCP server
export const deleteCustomMcpServer = async (serverId: string): Promise<void> => {
  await ultraaiApi.delete(`/custom-mcp-servers/${serverId}`);
};
...
export const testCustomMcpServer = async (
  ...
  const response = await ultraaiApi.get(`/custom-mcp-servers/${serverId}/test`);
  return extractData<any>(response);
};
