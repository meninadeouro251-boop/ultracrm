...
export class ReconnectService {
  ...
  private init() {
    ...
    window.addEventListener('Ultra:connection_failed', this.handleConnectionFailed.bind(this));
  ...
  destroy() {
    ...
    window.removeEventListener('Ultra:connection_failed', this.handleConnectionFailed.bind(this));
