...
export interface MessageCreatedEvent {
  ...
  account_id: string;
  /** ID temporário do frontend; backend dultralve no WS para substituir a mensagem pending */
  echo_id?: string;
  attachments?: Array<{
    id: string;
    message_id: string;
...
export interface ConversationCreatedEvent {
  ...
  labels: string[]; // Ultra usa string[] para labels
  unread_count: number;
 ...
 * Conector específico para eventos de chat do Ultra
 * Baseado em: Ultra/app/javascript/dashboard/helper/actionCable.js
 */
