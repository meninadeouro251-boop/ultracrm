...
export interface WhatsappUltraPayload {
  name: string;
  display_name?: string;
  channel: {
    type: 'whatsapp';
...
export interface WhatsappUltraGoPayload {
  name: string;
  display_name?: string;
  channel: {
    type: 'whatsapp';
...
export interface UltraInstance {
  instance_name: string;
...
export interface UltraConnectionParams {
  apiUrl: string;
  adminToken: string;
  instanceName: string;
  phoneNumber: string;
...
export interface UltraAuthorizationResponse {
  success: boolean;
  instance_uuid?: string;
  instance_token?: string;
  qrcode?: string;
...
// ============================================
// Ultra Go Service Types
// ============================================

export interface UltraGoConnectionParams {
  apiUrl: string;
  adminToken: string;
  instanceName: string;
  phoneNumber: string;
...
export interface UltraGoAuthorizationResponse {
  success: boolean;
  instance_uuid?: string;
  instance_token?: string;
  qrcode?: string;
