...
interface InboxHook {
  ...
  isAWhatsAppUltraChannel: boolean;
  isAWhatsAppUltraGoChannel: boolean;
  ...
  return useMemo(() => {
    if (!inbox) {
      return {
        ...
        isAWhatsAppUltraChannel: false,
        isAWhatsAppUltraGoChannel: false,
    ...
    const isAWhatsAppUltraChannel =
      channelType === INBOX_TYPES.WHATSAPP && provider === WHATSAPP_PROVIDERS.Ultra;
    const isAWhatsAppUltraGoChannel =
      channelType === INBOX_TYPES.WHATSAPP && provider === WHATSAPP_PROVIDERS.Ultra_GO;
    ...
    else if (isAWhatsAppUltraChannel) whatsAppAPIProviderName = 'ultra';
    else if (isAWhatsAppUltraGoChannel) whatsAppAPIProviderName = 'Ultra Go';
    ...
    return {
      ...
      isAWhatsAppUltraChannel,
      isAWhatsAppUltraGoChannel,
