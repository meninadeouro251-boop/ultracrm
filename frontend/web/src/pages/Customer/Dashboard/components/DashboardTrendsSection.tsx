...
import { Badge, Card, CardContent, CardHeader, CardTitle } from '@ultraapi/design-system';
    ...
    <section className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          {tx('dashboard.sections.trendsSubtitle', 'ultralução da operação ao longo do período filtrado')}
        </p>
      </div>
