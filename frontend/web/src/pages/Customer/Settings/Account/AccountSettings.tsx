...
export default function AccountSettings() {
  ...
  const [globalConfig, setGlobalConfig] = useState<{
    gitSha?: string;
    appVersion?: string;
    isOnUltraCloud?: boolean;
  }>({});
  const [errors, setErrors] = useState<Record<string, string>>({});

  // Linguagens disponíveis - baseado no LANGUAGES_CONFIG do Ultra
  ...
  const isOnUltraCloud = globalConfig.isOnUltraCloud;
            ...
            >
              <form onSubmit={handleGeneralSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      className={`bg-sidebar border-sidebar-border text-sidebar-foreground ${errors.locale ? 'border-red-500' : ''
                        }`}
                    >
                      <SelectValue />
                    </SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2 items-center">
                      <Input
                        ...
                        className={`w-32 bg-sidebar border-sidebar-border text-sidebar-foreground ${errors.autoResolveAfter ? 'border-red-500' : ''
                          }`}
                      />
