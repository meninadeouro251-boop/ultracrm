      ...
      <div style={{ position: 'relative' }}>
        <select
          ...
          style={{
            ...
            height: '40px',
            background: '#0f1117',
            border: value ? '0.5px solid #2a2f3a' : '0.5px solid #1c1f2a',
            borderRadius: '8px',
          ...
          onFocus={(e) => {
            e.target.style.borderColor = '#014293';
            e.target.style.boxShadow = '0 0 0 2px rgba(1, 66, 147, 0.35)';
          }}
          onBlur={(e) => {
            e.target.style.borderColor = value ? '#2a2f3a' : '#1c1f2a';
            e.target.style.boxShadow = 'none';
          }}
        >
          <option value="" style={{ background: '#18181b', color: '#475569' }}>
            Selecionar...
          </option>
          {options.map((opt) => (
            <option key={opt} value={opt} style={{ background: '#18181b', color: '#f1f5f9' }}>
              {opt}
            </option>
          ))}
        </select>
  ...
  return (
    <>
      <style>{`
        ...
        .ultra-other-input input {
          width: 100%;
          height: 40px;
          background: #08090c;
          border: 0.5px solid #014293;
          box-shadow: 0 0 0 2px rgba(1, 66, 147, 0.35);
          border-radius: 8px;
          color: #f1f5f9;
          font-size: 14px;
        ...
        .ultra-other-input input::placeholder { color: #94a3b8; }
        .ultra-submit-btn {
          width: 100%;
          height: 40px;
          background: #014293;
        ...
        .ultra-submit-btn:disabled { opacity: 0.3; cursor: not-allowed; }
        .ultra-submit-btn:not(:disabled):hover { opacity: 0.88; }
        .ultra-submit-btn:not(:disabled):active { transform: scale(0.98); }
        .ultra-fields-grid {
          display: grid;
      ...
      <div
        className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-t from-primary/20 via-background/95 to-background relative"
        style={{
          fontFamily: 'ui-sans-serif, system-ui, sans-serif',
        }}
      >
        ...
        >
          ...
          <div className="flex flex-col items-center mb-6">
            <img src={logo} alt="Ultra CRM" className="h-10 mx-auto" />
          </div>

          {/* Title */}
          <div style={{ fontSize: '20px', fontWeight: 600, color: '#f1f5f9', marginBottom: '6px' }}>
            {t('survey.title')}
          </div>
          <div style={{ fontSize: '13px', color: '#94a3b8', lineHeight: '1.55', marginBottom: '1.75rem' }}>
            {t('survey.subtitle')}
          </div>
            ...
            <div>
              ...
              <div style={{ marginBottom: '1.1rem' }}>
                ...
                <div style={{ position: 'relative' }}>
                  <select
                    ...
                    style={{
                      ...
                      height: '40px',
                      background: '#08090c',
                      border: form.mainChannel ? '0.5px solid #2a2f3a' : '0.5px solid #1c1f2a',
                      borderRadius: '8px',
                      color: form.mainChannel ? '#f1f5f9' : '#94a3b8',
                      fontSize: '14px',
                      fontFamily: 'ui-sans-serif, system-ui, sans-serif',
                      padding: '0 36px 0 12px',
                      appearance: 'none',
                    ...
                    onBlur={(e) => {
                      e.target.style.borderColor = form.mainChannel ? '#2a2f3a' : '#1c1f2a';
                      e.target.style.boxShadow = 'none';
                    }}
                  >
                    <option value="" style={{ background: '#18181b', color: '#475569' }}>
                ...
                {form.mainChannel === t('survey.channel.other') && (
                  <div className="ultra-other-input">
                    <input
                      type="text"
                      placeholder={t('survey.channel.otherPlaceholder')}
                      value={form.mainChannelOther}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => set('mainChannelOther')(e.target.value)}
                      autoFocus
                    />
                  </div>
                )}
          ...
          {/* Divider */}
          <div style={{ borderTop: '0.5px solid #1c1f2a', margin: '1.5rem 0 1.25rem' }} />
          ...
          <div style={{ textAlign: 'center', fontSize: '11px', color: '#475569', marginTop: '1rem' }}>
            {t('survey.footer')}
          </div>
        </div>
      </div>
