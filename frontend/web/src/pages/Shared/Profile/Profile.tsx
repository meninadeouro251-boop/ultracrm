        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setUserData(prev => ({ ...prev, message_signature: e.target.value }))}
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked: boolean) => handleAudioSettingsChange({ enable_audio_alerts: checked })}
          />
        </div>
