...
import { Alert, AlertTitle, AlertDescription } from '@ultraapi/design-system';
...
export const OAuthLogin: React.FC = () => {
  ...
  const handleLogin = () => {
    ...
    try {
      // Redirecionar para a página de login normal do Ultra
      ...
      <div className="w-full max-w-md space-y-6">
        <div className="bg-background/80 backdrop-blur-sm border rounded-lg p-6 shadow-lg">
          ...
          <div className="mt-6 text-xs text-muted-foreground text-center">
            ...
            <p className="mt-2">{t('login.footer.rultrake')}</p>
          </div>
        </div>
      </div>
    </div>
