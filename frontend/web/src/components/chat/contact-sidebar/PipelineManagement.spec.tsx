...
vi.mock('@ultraapi/design-system/label', () => ({
  Label: ({ children, ...props }: any) => <label {...props}>{children}</label>,
}));

vi.mock('@ultraapi/design-system/alert-dialog', () => ({
