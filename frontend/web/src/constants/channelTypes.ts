...
export const getChannelTypes = (): ChannelType[] => [
  ...
  },
  {
    ...
    providers: [
      ...
      {
        id: 'ultra',
        name: i18n.t('channels:newChannel.providers.Ultra.name'),
        description: i18n.t('channels:newChannel.providers.Ultra.description'),
        popular: false,
      },
      {
        id: 'ultra_go',
        name: i18n.t('channels:newChannel.providers.UltraGo.name'),
        description: i18n.t('channels:newChannel.providers.UltraGo.description'),
        popular: true,
      },
      {
        id: 'notificame',
