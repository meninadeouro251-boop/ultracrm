# 🤝 Guia de Contribuição - ultraAI Frontend
...
│   │       └── Slack/
│   │
│   └── ui/             # Componentes do design system (@ultraapi/design-system)
│       ├── Button/
│       ├── Input/
│       ├── Select/
│       └── Modal/
...
- [Guia de Análise e Organização de Código](../../../Documentações/ultraAI%20Services/09-ultra-ai-frontend/08-analise-organizacao-codigo.md)
...
**Mantido por:** Equipe ultraAI Frontend
