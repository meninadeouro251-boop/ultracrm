...
import (
	...
	"github.com/ultralutionAPI/ultra-bot-runtime/internal/config"
...
func main() {
	...
	go func() {
		log.Printf("ultra-bot-runtime starting on %s", cfg.ListenAddr)
	...
	defer stop()
	<-ctx.Done()
	log.Printf("ultra-bot-runtime shutting down")
