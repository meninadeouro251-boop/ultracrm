...
Comandos mais usados no dia a dia de desenvolvimento do ultralution GO.
...
docker tag ultralution-go:latest seu-registry/ultralution-go:v1.0.0
docker push seu-registry/ultralution-go:v1.0.0
```
