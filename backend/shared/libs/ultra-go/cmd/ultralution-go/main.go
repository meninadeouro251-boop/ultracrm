...
import (
	...
	call_handler "github.com/ultralutionAPI/ultralution-go/pkg/call/handler"
	call_service "github.com/ultralutionAPI/ultralution-go/pkg/call/service"
	chat_handler "github.com/ultralutionAPI/ultralution-go/pkg/chat/handler"
	chat_service "github.com/ultralutionAPI/ultralution-go/pkg/chat/service"
	community_handler "github.com/ultralutionAPI/ultralution-go/pkg/community/handler"
	community_service "github.com/ultralutionAPI/ultralution-go/pkg/community/service"
	config "github.com/ultralutionAPI/ultralution-go/pkg/config"
	"github.com/ultralutionAPI/ultralution-go/pkg/core"
	producer_interfaces "github.com/ultralutionAPI/ultralution-go/pkg/events/interfaces"
	nats_producer "github.com/ultralutionAPI/ultralution-go/pkg/events/nats"
	rabbitmq_producer "github.com/ultralutionAPI/ultralution-go/pkg/events/rabbitmq"
	webhook_producer "github.com/ultralutionAPI/ultralution-go/pkg/events/webhook"
	websocket_producer "github.com/ultralutionAPI/ultralution-go/pkg/events/websocket"
	group_handler "github.com/ultralutionAPI/ultralution-go/pkg/group/handler"
	group_service "github.com/ultralutionAPI/ultralution-go/pkg/group/service"
	instance_handler "github.com/ultralutionAPI/ultralution-go/pkg/instance/handler"
	instance_model "github.com/ultralutionAPI/ultralution-go/pkg/instance/model"
	instance_repository "github.com/ultralutionAPI/ultralution-go/pkg/instance/repository"
	instance_service "github.com/ultralutionAPI/ultralution-go/pkg/instance/service"
	label_handler "github.com/ultralutionAPI/ultralution-go/pkg/label/handler"
	label_model "github.com/ultralutionAPI/ultralution-go/pkg/label/model"
	label_repository "github.com/ultralutionAPI/ultralution-go/pkg/label/repository"
	label_service "github.com/ultralutionAPI/ultralution-go/pkg/label/service"
	logger_wrapper "github.com/ultralutionAPI/ultralution-go/pkg/logger"
	message_handler "github.com/ultralutionAPI/ultralution-go/pkg/message/handler"
	message_model "github.com/ultralutionAPI/ultralution-go/pkg/message/model"
	message_repository "github.com/ultralutionAPI/ultralution-go/pkg/message/repository"
	message_service "github.com/ultralutionAPI/ultralution-go/pkg/message/service"
	auth_middleware "github.com/ultralutionAPI/ultralution-go/pkg/middleware"
	newsletter_handler "github.com/ultralutionAPI/ultralution-go/pkg/newsletter/handler"
	newsletter_service "github.com/ultralutionAPI/ultralution-go/pkg/newsletter/service"
	poll_handler "github.com/ultralutionAPI/ultralution-go/pkg/poll/handler"
	routes "github.com/ultralutionAPI/ultralution-go/pkg/routes"
	send_handler "github.com/ultralutionAPI/ultralution-go/pkg/sendMessage/handler"
	send_service "github.com/ultralutionAPI/ultralution-go/pkg/sendMessage/service"
	server_handler "github.com/ultralutionAPI/ultralution-go/pkg/server/handler"
	storage_interfaces "github.com/ultralutionAPI/ultralution-go/pkg/storage/interfaces"
	minio_storage "github.com/ultralutionAPI/ultralution-go/pkg/storage/minio"
	"github.com/ultralutionAPI/ultralution-go/pkg/telemetry"
	user_handler "github.com/ultralutionAPI/ultralution-go/pkg/user/handler"
	user_service "github.com/ultralutionAPI/ultralution-go/pkg/user/service"
	whatsmeow_service "github.com/ultralutionAPI/ultralution-go/pkg/whatsmeow/service"
...
// @title ultralution GO
// @version 1.0
// @description ultralution GO - whatsmeow
func main() {
	flag.Parse()
	if *devMode {
	...
	logger.LogInfo("Starting ultralution GO version %s", version)
