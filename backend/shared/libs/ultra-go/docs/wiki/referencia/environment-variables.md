...
Referência rápida de variáveis de ambiente do ultralution GO.
...
| `CLIENT_NAME` | `ultralution` | Nome identificador |
...
**Formato:**
```env
POSTGRES_AUTH_DB=postgresql://user:pass@host:5432/ultrago_auth?sslmode=disable
POSTGRES_USERS_DB=postgresql://user:pass@host:5432/ultrago_users?sslmode=disable
```
...
- **[.env.example](https://git.ultraai.app/ultralution/ultralution-go/blob/main/docker/examples/.env.example)** - Arquivo de exemplo com todas as variáveis
