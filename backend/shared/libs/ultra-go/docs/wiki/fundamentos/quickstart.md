...
Tutorial prático para configurar sua primeira instância WhatsApp e enviar mensagens via ultralution GO.

## Pré-requisitos

- ultralution GO instalado e em execução
...
curl -X POST http://localhost:4000/send/text \
  ...
  -d '{
    ...
    "text": "Mensagem de teste via ultralution GO"
  }'
```
