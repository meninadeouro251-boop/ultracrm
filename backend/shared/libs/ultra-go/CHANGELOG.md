...
### 🐛 Bug Fixes
- **Admin rultrake** — Allow deleting messages from others in groups (admin rultrake)
...
**Docker:** `ultraapicloud/ultralution-go:0.5.3`
...
**Docker:** `ultraapicloud/ultralution-go:0.5.2`
...
**Docker:** `ultraapicloud/ultralution-go:0.5.1`
...
**Docker:** `ultraapicloud/ultralution-go:0.5.0`
...
**Docker:** `ultraapicloud/ultralution-go:0.4.9`
...
**Docker:** `ultraapicloud/ultralution-go:0.4.8`
...
**Docker:** `ultraapicloud/ultralution-go:0.4.7`
...
**Docker:** `ultraapicloud/ultralution-go:0.4.6`
...
**Docker:** `ultraapicloud/ultralution-go:0.4.5`
...
**Docker:** `ultraapicloud/ultralution-go:0.4.4`
...
**Docker:** `ultraapicloud/ultralution-go:0.4.3`
...
### 🆕 Initial Features
- Base implementation of Ultra API in Go
...
- **Docker Hub**: `ultraapicloud/ultralution-go`
- **Documentation**: Swagger available at `/swagger/`
- **GitHub**: [Ultra API Go](https://github.com/ultralutionAPI/ultralution-go)
