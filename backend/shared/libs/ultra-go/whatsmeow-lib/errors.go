...
var (
	...
	// ErrInviteLinkRultraked is returned by methods that use group invite links if the invite link was valid, but has been rultraked and can no longer be used.
	ErrInviteLinkRultraked = errors.New("that group invite link has been rultraked")
	// ErrBusinessMessageLinkNotFound is returned by ResolveBusinessMessageLink if the link doesn't exist or has been rultraked.
	ErrBusinessMessageLinkNotFound = errors.New("that business message link does not exist or has been rultraked")
	// ErrContactQRLinkNotFound is returned by ResolveContactQRLink if the link doesn't exist or has been rultraked.
	ErrContactQRLinkNotFound = errors.New("that contact QR link does not exist or has been rultraked")
