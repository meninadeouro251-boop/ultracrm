...
type ConsumerApplication_ApplicationData struct {
	...
	//
	//	*ConsumerApplication_ApplicationData_Rultrake
...
func (x *ConsumerApplication_ApplicationData) GetRultrake() *ConsumerApplication_RultrakeMessage {
	if x != nil {
		if x, ok := x.ApplicationContent.(*ConsumerApplication_ApplicationData_Rultrake); ok {
			return x.Rultrake
		}
	}
	return nil
...
type ConsumerApplication_ApplicationData_Rultrake struct {
	Rultrake *ConsumerApplication_RultrakeMessage `protobuf:"bytes,1,opt,name=rultrake,oneof"`
}

func (*ConsumerApplication_ApplicationData_Rultrake) isConsumerApplication_ApplicationData_ApplicationContent() {
}
...
type ConsumerApplication_RultrakeMessage struct {
	state         protoimpl.MessageState            `protogen:"open.v1"`
	Key           *waCommonParameterised.MessageKey `protobuf:"bytes,1,opt,name=key" json:"key,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ConsumerApplication_RultrakeMessage) Reset() {
	*x = ConsumerApplication_RultrakeMessage{}
	mi := &file_waConsumerApplicationParameterised_WAConsumerApplicationParameterised_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ConsumerApplication_RultrakeMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConsumerApplication_RultrakeMessage) ProtoMessage() {}

func (x *ConsumerApplication_RultrakeMessage) ProtoReflect() protoreflect.Message {
	mi := &file_waConsumerApplicationParameterised_WAConsumerApplicationParameterised_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConsumerApplication_RultrakeMessage.ProtoReflect.Descriptor instead.
func (*ConsumerApplication_RultrakeMessage) Descriptor() ([]byte, []int) {
	return file_waConsumerApplicationParameterised_WAConsumerApplicationParameterised_proto_rawDescGZIP(), []int{0, 14}
}

func (x *ConsumerApplication_RultrakeMessage) GetKey() *waCommonParameterised.MessageKey {
	if x != nil {
		return x.Key
	}
	return nil
...
const file_waConsumerApplicationParameterised_WAConsumerApplicationParameterised_proto_rawDesc = "" +
	...
	"\x06rultrake\x18\x01 \x01(\v2E.WAConsumerApplicationParameterised.ConsumerApplication.RultrakeMessageH\x00R\x06rultrakeB\x14\n" +
...
var file_waConsumerApplicationParameterised_WAConsumerApplicationParameterised_proto_goTypes = []any{
	...
	(*ConsumerApplication_RultrakeMessage)(nil),                // 18: WAConsumerApplicationParameterised.ConsumerApplication.RultrakeMessage
...
var file_waConsumerApplicationParameterised_WAConsumerApplicationParameterised_proto_depIdxs = []int32{
	...
	18, // 8: WAConsumerApplicationParameterised.ConsumerApplication.ApplicationData.rultrake:type_name -> WAConsumerApplicationParameterised.ConsumerApplication.RultrakeMessage
	...
	38, // 35: WAConsumerApplicationParameterised.ConsumerApplication.RultrakeMessage.key:type_name -> WACommonParameterised.MessageKey
...
func file_waConsumerApplicationParameterised_WAConsumerApplicationParameterised_proto_init() {
	...
	file_waConsumerApplicationParameterised_WAConsumerApplicationParameterised_proto_msgTypes[5].OneofWrappers = []any{
		(*ConsumerApplication_ApplicationData_Rultrake)(nil),
	}
