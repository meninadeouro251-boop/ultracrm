...
const (
	...
	WebMessageInfo_RultraKE                                                   WebMessageInfo_StubType = 1
	...
	WebMessageInfo_ADMIN_RultraKE                                             WebMessageInfo_StubType = 132
...
type WebMessageInfo struct {
	...
	RultrakeMessageTimestamp               *uint64                               `protobuf:"varint,52,opt,name=rultrakeMessageTimestamp" json:"rultrakeMessageTimestamp,omitempty"`
...
func (x *WebMessageInfo) GetRultrakeMessageTimestamp() uint64 {
	if x != nil && x.RultrakeMessageTimestamp != nil {
		return *x.RultrakeMessageTimestamp
	}
	return 0
}
...
const file_waWeb_WAWebProtobufsWeb_proto_rawDesc = "" +
	...
	"\x16rultrakeMessageTimestamp\x184 \x01(\x04R\x16rultrakeMessageTimestamp\x12:\n" +
	...
	"\fADMIN_RultraKE\x10\x84\x01\x12$\n" +
