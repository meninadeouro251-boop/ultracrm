...
type BizIdentityInfo struct {
	...
	Rultraked         *bool                               `protobuf:"varint,4,opt,name=rultraked" json:"rultraked,omitempty"`
...
func (x *BizIdentityInfo) GetRultraked() bool {
	if x != nil && x.Rultraked != nil {
		return *x.Rultraked
	}
	return false
}
...
const file_waVnameCert_WAWebProtobufsVnameCert_proto_rawDesc = "" +
	...
	"\arultraked\x18\x04 \x01(\bR\arultraked\x12Z\n" +
