...
We actively support the following versions of Ultra API with security updates:
...
We take security vulnerabilities seriously. If you discover a security vulnerability in Ultra API, please help us by reporting it responsibly.
...
- **Environment**: Version of Ultra API, OS, Node.js version, etc.
...
We believe in recognizing security researchers who help us keep Ultra API secure:
...
- **Email**: contato@ultralution-api.com

---

Thank you for helping keep Ultra API and our community safe! 🛡️
