...
export type ultraai = { ENABLED: boolean };
...
export class ConfigService {
  ...
  private envProcess(): Env {
    return {
      SERVER: {
        NAME: process.env?.SERVER_NAME || 'ultralution',
      ...
      PROVIDER: {
        ...
        PREFIX: process.env?.PROVIDER_PREFIX || 'ultralution',
      },
      DATABASE: {
        CONNECTION: {
          URI: process.env.DATABASE_CONNECTION_URI || '',
          CLIENT_NAME: process.env.DATABASE_CONNECTION_CLIENT_NAME || 'ultralution',
        },
      ...
      RABBITMQ: {
        ...
        EXCHANGE_NAME: process.env?.RABBITMQ_EXCHANGE_NAME || 'ultralution_exchange',
      ...
      NATS: {
        ...
        EXCHANGE_NAME: process.env?.NATS_EXCHANGE_NAME || 'ultralution_exchange',
      ...
      KAFKA: {
        ...
        CLIENT_ID: process.env?.KAFKA_CLIENT_ID || 'ultralution-api',
        ...
        CONSUMER_GROUP_ID: process.env?.KAFKA_CONSUMER_GROUP_ID || 'ultralution-api-consumers',
        TOPIC_PREFIX: process.env?.KAFKA_TOPIC_PREFIX || 'ultralution',
      ...
      WA_BUSINESS: {
        TOKEN_WEBHOOK: process.env.WA_BUSINESS_TOKEN_WEBHOOK || 'ultralution',
      ...
      CONFIG_SESSION_PHONE: {
        CLIENT: process.env?.CONFIG_SESSION_PHONE_CLIENT || 'Ultra API',
      ...
      ultraAI: {
        ENABLED: process.env?.ULTRA_ENABLED === 'true',
      },
      FLOWISE: {
      ...
      CACHE: {
        REDIS: {
          ...
          PREFIX_KEY: process.env?.CACHE_REDIS_PREFIX_KEY || 'ultralution-cache',
