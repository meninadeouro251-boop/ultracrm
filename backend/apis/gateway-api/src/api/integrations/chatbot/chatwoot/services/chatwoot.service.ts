  ...
  public async initInstanceChatwoot(
    ...
    const contact =
      ...
      ((await this.createContact(
        ...
        inboxId,
        false,
        organization ? organization : 'ultralutionAPI',
        logo ? logo : 'https://ultralution-api.com/files/ultralution-api-favicon.png',
      )) as any);
    ...
    try {
      ...
      if (event === 'messages.edit' || event === 'send.message.update') {
        ...
        if (!editedMessageContent) {
          this.logger.info('[CW.EDIT] Conteúdo vazio — ignorando (DELETE tratará se for rultrake).');
          return;
        }
