...
import { ultraaiRouter } from './ultraai/routes/ultraai.router';
import { ultralutionBotRouter } from './ultralutionBot/routes/ultralutionBot.router';
...
export class ChatbotRouter {
  ...
  constructor(...guards: any[]) {
    ...
    this.router.use('/ultralutionBot', new ultralutionBotRouter(...guards).router);
    ...
    this.router.use('/ultraai', new ultraaiRouter(...guards).router);
  }
}
