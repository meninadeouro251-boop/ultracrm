...
export class ultralutionStartupService extends ChannelStartupService {
  constructor(
  ...
  public async locationMessage() {
    throw new BadRequestException('Method not available on ultralution Channel');
  }
  ...
  public async rultrakeInviteCode() {
    throw new BadRequestException('Method not available on ultralution Channel');
  }
