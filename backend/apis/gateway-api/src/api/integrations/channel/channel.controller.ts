...
import { ultralutionStartupService } from './ultralution/ultralution.channel.service';
...
export class ChannelController {
  ...
  public init(instanceData: InstanceDto, data: ChannelDataType) {
    ...
    if (instanceData.integration === Integration.ultraLUTION) {
      return new ultralutionStartupService(
        data.configService,
        data.eventEmitter,
        data.prismaRepository,
        data.cache,
