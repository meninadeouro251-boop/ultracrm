...
import { ultralutionController } from './integrations/channel/ultralution/ultralution.controller';
...
import { ultraaiController } from './integrations/chatbot/ultraai/controllers/ultraai.controller';
import { ultraaiService } from './integrations/chatbot/ultraai/services/ultraai.service';
import { ultralutionBotController } from './integrations/chatbot/ultralutionBot/controllers/ultralutionBot.controller';
import { ultralutionBotService } from './integrations/chatbot/ultralutionBot/services/ultralutionBot.service';
...
// channels
export const ultralutionController = new ultralutionController(prismaRepository, waMonitor);
...
const ultralutionBotService = new ultralutionBotService(waMonitor, prismaRepository, configService, openaiService);
export const ultralutionBotController = new ultralutionBotController(ultralutionBotService, prismaRepository, waMonitor);
...
const ultraaiService = new ultraaiService(waMonitor, prismaRepository, configService, openaiService);
export const ultraaiController = new ultraaiController(ultraaiService, prismaRepository, waMonitor);
