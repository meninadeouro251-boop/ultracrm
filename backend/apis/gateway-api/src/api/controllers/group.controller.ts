...
export class GroupController {
  ...
  public async rultrakeInviteCode(instance: InstanceDto, groupJid: GroupJid) {
    return await this.waMonitor.waInstances[instance.instanceName].rultrakeInviteCode(groupJid);
  }
