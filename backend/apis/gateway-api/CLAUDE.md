...
This file provides comprehensive guidance to Claude AI when working with the Ultra API codebase.

## Project Overview

**Ultra API** is a powerful, production-ready REST API for WhatsApp communication that supports multiple WhatsApp providers:
...
- **WhatsApp integrations**: Baileys, Meta Business API, and Ultra API with unified interface
...
- **ultralutionBot**: Native chatbot with trigger system
