...
import { ultraai } from "@/pages/instance/ultraai";
import { ultralutionBot } from "@/pages/instance/ultralutionBot";
...
const router = createBrowserRouter([
  ...
  {
    path: "/manager/instance/:instanceId/ultraai",
    element: (
      <ProtectedRoute>
        <InstanceLayout>
          <ultraai />
  ...
  {
    path: "/manager/instance/:instanceId/ultraai/:ultraaiId",
    element: (
      <ProtectedRoute>
        <InstanceLayout>
          <ultraai />
  ...
  {
    path: "/manager/instance/:instanceId/ultralutionBot",
    element: (
      <ProtectedRoute>
        <InstanceLayout>
          <ultralutionBot />
  ...
  {
    path: "/manager/instance/:instanceId/ultralutionBot/:ultralutionBotId",
    element: (
      <ProtectedRoute>
        <InstanceLayout>
          <ultralutionBot />
