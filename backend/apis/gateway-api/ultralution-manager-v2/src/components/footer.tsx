...
function Footer() {
  ...
  const links = [
    {
      name: "Discord",
      url: "https://ultralution-api.com/discord",
    },
    {
      name: "Postman",
      url: "https://ultralution-api.com/postman",
    },
    {
      name: "GitHub",
      url: "https://github.com/ultralutionAPI/ultralution-api",
    },
    {
      name: "Docs",
      url: "https://doc.ultralution-api.com",
    },
  ];
