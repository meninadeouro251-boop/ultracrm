    ...
    () => [
      ...
      },
      {
        ...
        children: [
          ...
          {
            id: "ultralutionBot",
            title: t("sidebar.ultralutionBot"),
            path: "ultralutionBot",
          },
          {
            id: "chatwoot",
      ...
      },
      {
        ...
        icon: FileQuestion,
        link: "https://doc.ultralution-api.com",
        divider: true,
      },
      {
        id: "postman",
        ...
        icon: CircleHelp,
        link: "https://ultralution-api.com/postman",
      },
      {
        id: "discord",
        title: t("sidebar.discord"),
        icon: MessageCircle,
        link: "https://ultralution-api.com/discord",
      },
      {
        id: "support-premium",
        title: t("sidebar.supportPremium"),
        icon: LifeBuoy,
        link: "https://ultralution-api.com/suporte-pro",
      },
    ],
    [t],
  );
