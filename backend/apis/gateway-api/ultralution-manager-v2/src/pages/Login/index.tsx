  ...
  return (
    <div className="flex min-h-screen flex-col">
      <div className="flex items-center justify-center pt-2">
        <img className="h-10" src={theme === "dark" ? "https://ultralution-api.com/files/ultra/ultralution-logo-white.svg" : "https://ultralution-api.com/files/ultra/ultralution-logo.svg"} alt="logo" />
      </div>
