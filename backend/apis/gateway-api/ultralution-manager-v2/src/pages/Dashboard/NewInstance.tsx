...
import { NewInstance as NewInstanceType } from "@/types/ultralution.types";
...
const FormSchema = z.object({
  ...
  integration: z.enum(["WHATSAPP-BUSINESS", "WHATSAPP-BAILEYS", "ultraLUTION"]),
});
...
function NewInstance({ resetTable }: { resetTable: () => void }) {
  ...
  const options = [
    ...
    {
      value: "ultraLUTION",
      label: t("instance.form.integration.ultralution"),
    },
  ];
