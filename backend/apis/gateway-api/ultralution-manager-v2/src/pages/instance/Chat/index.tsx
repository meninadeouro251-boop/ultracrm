...
import { Chat as ChatType } from "@/types/ultralution.types";
                      ...
                      (chat: ChatType) =>
                        chat.remoteJid.includes("@s.whatsapp.net") && (
                          <Link
                            ...
                            className={`chat-item flex items-center overflow-hidden truncate whitespace-nowrap rounded-md border-b border-gray-600/50 p-2 text-sm transition-colors hover:bg-muted/50 ${remoteJid === chat.remoteJid ? "active" : ""
                              }`}>
