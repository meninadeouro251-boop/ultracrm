...
All notable changes to ultraAuth Service will be documented in this file.
...
- **Token Validation**: Enhanced Bearer token validation with ultraAuth service integration
...
- **OAuth 2.0 Provider**
  ...
  - Token introspection and rultracation
...
- **Issues**: [GitHub Issues](https://github.com/ultralutionAPI/ultra-auth-service/issues)
- **Email**: [support@ultra-auth-service-community.com](mailto:support@ultra-auth-service-community.com)
