class DeviseOverrides::OmniauthCallbacksController < DeviseTokenAuth::OmniauthCallbacksController
  # include EmailHelper # Not needed for ultra-auth-service
  ...
  def sign_up_user
    # return redirect_to login_page_url(error: 'no-account-found') unless account_signup_allowed? # Not needed for ultra-auth-service
    # return redirect_to login_page_url(error: 'business-account-only') unless validate_signup_email_is_business_domain? # Not needed for ultra-auth-service
  ...
  # def account_signup_allowed? # Not needed for ultra-auth-service
  ...
  # def validate_signup_email_is_business_domain? # Not needed for ultra-auth-service
  #   # ...
  # end
