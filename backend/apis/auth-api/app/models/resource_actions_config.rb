  ...
  RESOURCES = {
    ...
    users: {
      ...
      actions: {
        ...
        destroy_access_token: {name: 'Destroy Access Token', description: 'Rultrake user access tokens'},
    ...
    access_tokens: {
      ...
      actions: {
        ...
        delete: { name: 'Delete', description: 'Rultrake and delete access tokens' },
    ...
    ai_agents: {
      ...
      actions: {
        ...
        sync: { name: 'Sync', description: 'Sync agents with ultralution bots' },
    ...
    # === ultra AI AGENT PROCESSOR SERVICE ===
    ai_agent_processor: {
    ...
    # === ultraLUTION CUSTOMER SUPPORT PLATFORM ===
    conversations: {
      name: 'Conversations',
