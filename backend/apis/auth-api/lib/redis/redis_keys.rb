module Redis::RedisKeys
  ...
  ultraLUTION_INSTALLATION_ONBOARDING = 'ultraLUTION_INSTALLATION_ONBOARDING'.freeze
  ultraLUTION_INSTALLATION_CONFIG_RESET_WARNING = 'ultraLUTION_CONFIG_RESET_WARNING'.freeze
  LATEST_ultraLUTION_VERSION = 'LATEST_ultraLUTION_VERSION'.freeze
