DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'ultra_core_mcp_servers') THEN
        
        -- Insert Brave Search
        IF NOT EXISTS (SELECT 1 FROM ultra_core_mcp_servers WHERE id = 'b73dc2e8-9d91-4167-a8f1-1102c42af3d2'::uuid) THEN
            INSERT INTO ultra_core_mcp_servers (id, name, description, config_type, config_json, environments, tools, type, created_at, updated_at)
            VALUES (
        ...
        -- Insert Github
        IF NOT EXISTS (SELECT 1 FROM ultra_core_mcp_servers WHERE id = '49c7b182-b341-4cc4-864c-7ae623ba41a7'::uuid) THEN
            INSERT INTO ultra_core_mcp_servers (id, name, description, config_type, config_json, environments, tools, type, created_at, updated_at)
            VALUES (
        ...
        IF NOT EXISTS (SELECT 1 FROM ultra_core_mcp_servers WHERE id = '6e878520-4a49-45f8-b42c-621bffcf70bf'::uuid) THEN
            INSERT INTO ultra_core_mcp_servers (id, name, description, config_type, config_json, environments, tools, type, created_at, updated_at)
            VALUES (
        ...
        -- Insert Gitlab
        IF NOT EXISTS (SELECT 1 FROM ultra_core_mcp_servers WHERE id = 'b626b528-13ac-4d63-aa74-c4acecde9e29'::uuid) THEN
            INSERT INTO ultra_core_mcp_servers (id, name, description, config_type, config_json, environments, tools, type, created_at, updated_at)
            VALUES (
        ...
        -- Insert Airbnb
        IF NOT EXISTS (SELECT 1 FROM ultra_core_mcp_servers WHERE id = '7bb73ef1-22da-4c05-a05d-d31db4243560'::uuid) THEN
            INSERT INTO ultra_core_mcp_servers (id, name, description, config_type, config_json, environments, tools, type, created_at, updated_at)
            VALUES (
        ...
        -- Insert Serper
        IF NOT EXISTS (SELECT 1 FROM ultra_core_mcp_servers WHERE id = 'ae214cb1-92f0-473c-93a3-e2075884bf4d'::uuid) THEN
            INSERT INTO ultra_core_mcp_servers (id, name, description, config_type, config_json, environments, tools, type, created_at, updated_at)
            VALUES (
        ...
        -- Insert Firecrawl
        IF NOT EXISTS (SELECT 1 FROM ultra_core_mcp_servers WHERE id = '01bcc7ef-a6a5-4264-9e47-9f565499eaaa'::uuid) THEN
            INSERT INTO ultra_core_mcp_servers (id, name, description, config_type, config_json, environments, tools, type, created_at, updated_at)
            VALUES (
        ...
        RAISE NOTICE 'Seeder executed successfully! % MCP servers inserted into ultra_core_mcp_servers table.', 8;
        
    ELSE
        RAISE NOTICE 'Table ultra_core_mcp_servers not found. Seeder not executed.';
    END IF;
END $$;
