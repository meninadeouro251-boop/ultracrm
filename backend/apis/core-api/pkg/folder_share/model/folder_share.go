...
import (
	folderModel "ultra-ai-core-service/pkg/folder/model"
	"time"
...
type FolderShare struct {
	...
	FolderID         uuid.UUID          `json:"-" gorm:"<-:create;type:uuid;not null; type:uuid;references:ultra_core_folders(id)"`
...
func (FolderShare) TableName() string {
	return "ultra_core_folder_shares"
}
