...
class Settings(BaseSettings):
    ...
    # API settings
    API_TITLE: str = os.getenv("API_TITLE", "Ultra CRM Agent Processor")
    API_DESCRIPTION: str = os.getenv("API_DESCRIPTION", "Agent Processor for Ultra CRM")
    API_VERSION: str = os.getenv("API_VERSION", "1.0.0")
    API_URL: str = os.getenv("API_URL", "http://localhost:8000")
    
    # Ultra CRM Configuration
    ULTRA_CRM_BASE_URL: str = os.getenv("ULTRA_CRM_BASE_URL", "http://localhost:3000")
    ULTRA_AUTH_BASE_URL: str = os.getenv("ULTRA_AUTH_BASE_URL", "http://localhost:3001")
    ULTRA_CORE_BASE_URL: str = os.getenv("ULTRA_CORE_BASE_URL", "http://localhost:5555")
    
    # Encryption settings (shared with ultra-ai-core-service)
    ENCRYPTION_KEY: str = os.getenv("ENCRYPTION_KEY", "")

    # Organization settings
    ORGANIZATION_NAME: str = os.getenv("ORGANIZATION_NAME", "Ultra CRM")
    ORGANIZATION_URL: str = os.getenv(
        "ORGANIZATION_URL", "https://ultracrm.app"
    )

    # Database settings
    POSTGRES_CONNECTION_STRING: str = os.getenv(
        "POSTGRES_CONNECTION_STRING", "postgresql://postgres:root@localhost:5432/ultra_community"
    )
    ...
    REDIS_KEY_PREFIX: str = os.getenv("REDIS_KEY_PREFIX", "ultra:")
    ...
    # Ultra CRM API settings (for CRM tools)
    ULTRA_CRM_API_TOKEN: Optional[str] = os.getenv("ULTRA_CRM_API_TOKEN")
    ULTRA_CRM_URL: str = os.getenv("ULTRA_CRM_URL", "http://localhost:3000")
