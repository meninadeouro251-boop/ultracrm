...
class GoogleSheetsService:
    ...
    def __init__(
        ...
        Args:
            ...
            core_service_url: Base URL for ultra-ai-core-service API
    ...
    async def save_configuration(
        ...
        """
        try:
            # Store configuration via ultra-ai-core API
    ...
    async def get_configuration(
        ...
        """
        try:
            # Get configuration via ultra-ai-core API
        ...
        try:
            ...
            if credentials and credentials.token:
                try:
                    ...
                    credentials.rultrake(Request())
                except Exception as e:
                    logger.warning(f"Error rultraking token: {e}")

            # Delete credentials and configuration via ultra-ai-core API
    ...
    async def _store_credentials(
        ...
        """Store OAuth credentials directly to database or via ultra-ai-core API."""
        credentials_data = {
        ...
        if db:
            ...
            # Store credentials via ultra-ai-core API
            url = f"{self.core_service_url}/agents/{agent_id}/integrations"
    ...
    async def _load_credentials(
        ...
        try:
            ...
            if not credentials_data:
                logger.info("Loading credentials from ultra-ai-core API")
