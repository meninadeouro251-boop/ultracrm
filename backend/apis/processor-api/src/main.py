...
from src.middleware.ultra_auth import UltraAuthMiddleware
...
initialize_permission_service(settings.ULTRA_AUTH_BASE_URL)
...
# UltraAuth middleware for authentication and user context
app.add_middleware(
    UltraAuthMiddleware
)
...
POSTGRES_CONNECTION_STRING = os.getenv(
    "POSTGRES_CONNECTION_STRING", "postgresql://postgres:root@localhost:5432/ultra_ai"
)
