...
This is the official and only A2A implementation for the ultra AI platform.
...
async def extract_conversation_history(
    ...
    try:
        ...
        # agent_id comes from the URL (/api/v1/a2a/{agent_id}) - this is the ultra-core-service agent ID
...
async def handle_message_send(
    ...
    try:
        ...
        # Build session_id using agent_id from URL (ultra-core-service agent ID)
        # Session ID format: {conversation_uuid}_{agent_id}
...
async def get_agent_card(
    ...
    agent_card = {
        ...
        "provider": {
            "organization": "ultra AI Platform",
