...
execution_metrics = sa.Table(
    'ultra_agent_processor_execution_metrics',
    metadata,
    ...
    sa.ForeignKeyConstraint(['agent_id'], ['ultra_core_agents.id'], ondelete='CASCADE'),
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_table('ultra_agent_processor_execution_metrics')
