<h1 align="center">Ultra CRM - Agent Processor</h1>
...
Ultra CRM Agent Processor is the core microservice of the Ultra CRM platform, responsible for orchestrating intelligent workflows between multiple agents, processing sessions, storing and searching knowledge in vector databases, and integrating with modern AI services. It provides:
...
```bash
git clone https://github.com/ultralutionAPI/ultra-crm-community.git
cd ultra-crm-community/ultra-ai-processor-community
```
