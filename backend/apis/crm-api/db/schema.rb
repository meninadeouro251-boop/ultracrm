...
ActiveRecord::Schema[7.1].define(version: 9025_08_19_224901) do
  ...
  create_table "ultra_agent_processor_execution_metrics", id: :uuid, default: nil, force: :cascade do |t|
    t.uuid "agent_id"
  ...
  create_table "ultra_ai_agent_processor_execution_metrics", id: :uuid, default: nil, force: :cascade do |t|
    t.uuid "agent_id"
    t.string "session_id", null: false
    t.string "user_id", null: false
    t.string "llm_model", null: false
  ...
  create_table "ultra_ai_agent_processor_session_metadata", primary_key: "session_id", id: :string, force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.json "tags"
  ...
  create_table "ultra_ai_agent_processor_sessions", id: :string, force: :cascade do |t|
    t.string "app_name"
    t.string "user_id"
    t.json "state"
  ...
  create_table "ultra_core_agent_folders", id: :uuid, default: nil, force: :cascade do |t|
    t.string "name", null: false
    t.text "description"
    t.timestamptz "created_at", default: -> { "now()" }
    t.timestamptz "updated_at"
  ...
  create_table "ultra_core_agent_integrations", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.uuid "agent_id", null: false
    t.string "provider", limit: 100, null: false
    t.jsonb "config", default: {}
    t.datetime "created_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.datetime "updated_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["agent_id"], name: "idx_ultra_core_agent_integrations_agent"
    t.index ["provider"], name: "idx_ultra_core_agent_integrations_provider"
    t.unique_constraint ["agent_id", "provider"], name: "unique_agent_integration"
  end

  create_table "ultra_core_agents", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.string "name", limit: 255, null: false
    t.text "description"
    ...
    t.datetime "created_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.datetime "updated_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.uuid "ultralution_bot_id"
    t.boolean "ultralution_bot_sync", default: false, null: false
    t.text "role"
    t.text "goal"
    t.index ["ultralution_bot_id"], name: "idx_agents_ultralution_bot_id"
    t.index ["ultralution_bot_sync"], name: "idx_agents_ultralution_bot_sync"
    t.index ["name"], name: "idx_ultra_core_agents_name"
    t.index ["name"], name: "idx_ultra_core_agents_name_unique", unique: true
  ...
  create_table "ultra_core_api_keys", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.string "name", limit: 255, null: false
    ...
    t.index ["is_active"], name: "idx_ultra_core_api_keys_is_active"
    t.index ["name"], name: "idx_ultra_core_api_keys_name"
    t.index ["name"], name: "idx_ultra_core_api_keys_name_unique", unique: true
  end

  create_table "ultra_core_community_schema_migrations", primary_key: "version", id: :bigint, default: nil, force: :cascade do |t|
    t.boolean "dirty", null: false
  end

  create_table "ultra_core_custom_mcp_servers", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.string "name", limit: 255, null: false
    t.text "description"
    ...
    t.timestamptz "created_at", default: -> { "now()" }
    t.timestamptz "updated_at", default: -> { "now()" }
    t.index ["name"], name: "idx_ultra_core_custom_mcp_servers_name"
    t.index ["name"], name: "idx_ultra_core_custom_mcp_servers_name_unique", unique: true
  end

  create_table "ultra_core_custom_tools", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.string "name", limit: 255, null: false
    t.text "description"
    ...
    t.timestamptz "created_at", default: -> { "now()" }
    t.timestamptz "updated_at", default: -> { "now()" }
    t.index ["name"], name: "idx_ultra_core_custom_tools_name"
    t.index ["name"], name: "idx_ultra_core_custom_tools_name_unique", unique: true
  end

  create_table "ultra_core_folder_shares", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.uuid "folder_id"
    ...
    t.datetime "created_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.datetime "updated_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["folder_id"], name: "idx_ultra_core_folder_shares_folder_id"
    t.index ["shared_by_user_id"], name: "idx_ultra_core_folder_shares_shared_by_user_id"
    t.index ["shared_with_user_id"], name: "idx_ultra_core_folder_shares_shared_with_user_id"
    t.check_constraint "permission_level::text = ANY (ARRAY['read'::text, 'write'::text])", name: "check_permission_level"
  end

  create_table "ultra_core_folders", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.string "name", limit: 255, null: false
    t.text "description"
    t.datetime "created_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.datetime "updated_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["name"], name: "idx_ultra_core_folders_name"
    t.index ["name"], name: "idx_ultra_core_folders_name_unique", unique: true
  end

  create_table "ultra_core_mcp_servers", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.string "name", limit: 255, null: false
    t.text "description"
    ...
    t.timestamptz "created_at", default: -> { "now()" }
    t.timestamptz "updated_at", default: -> { "now()" }
    t.index ["name"], name: "idx_ultra_core_mcp_servers_name", unique: true
  ...
  add_foreign_key "ultra_agent_processor_execution_metrics", "ultra_core_agents", column: "agent_id", name: "ultra_agent_processor_execution_metrics_agent_id_fkey", on_delete: :cascade
  add_foreign_key "ultra_ai_agent_processor_execution_metrics", "ultra_core_agents", column: "agent_id", name: "ultra_ai_agent_processor_execution_metrics_agent_id_fkey", on_delete: :cascade
  add_foreign_key "ultra_core_agent_integrations", "ultra_core_agents", column: "agent_id", name: "ultra_core_agent_integrations_agent_id_fkey", on_delete: :cascade
  add_foreign_key "ultra_core_agents", "ultra_core_api_keys", column: "api_key_id", name: "ultra_core_agents_api_key_id_fkey", on_delete: :nullify
  add_foreign_key "ultra_core_agents", "ultra_core_folders", column: "folder_id", name: "ultra_core_agents_folder_id_fkey", on_delete: :nullify
  add_foreign_key "ultra_core_folder_shares", "ultra_core_folders", column: "folder_id", name: "ultra_core_folder_shares_folder_id_fkey", on_delete: :cascade
