class RenameSensitiveKeysAndEncrypt < ActiveRecord::Migration[7.1]
  ...
  KEY_RENAMES = {
    ...
    'ultraLUTION_ADMIN_TOKEN' => 'ultraLUTION_ADMIN_SECRET',
    'ultraLUTION_GO_ADMIN_TOKEN' => 'ultraLUTION_GO_ADMIN_SECRET',
    'ultraLUTION_GO_INSTANCE_TOKEN' => 'ultraLUTION_GO_INSTANCE_SECRET'
  }.freeze
