...
RSpec.describe ultraAuthService do
  ...
  describe '#validate_token' do
    ...
    it 'maps auth-service unauthorized response to validation error with code' do
      ...
      end.to raise_error(ultraAuthService::ValidationError) { |error|
    ...
    it 'maps upstream server failures to authentication service error' do
      ...
      end.to raise_error(ultraAuthService::AuthenticationError, 'Authentication service unavailable')
    end
