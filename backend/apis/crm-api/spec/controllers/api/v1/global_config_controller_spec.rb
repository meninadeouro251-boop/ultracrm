  ...
  describe 'GET #show' do
    ...
    it 'exposes exactly the expected top-level keys (catches accidental additions/removals)' do
      ...
      expected_keys = %w[
        ...
        hasultralutionConfig hasultralutionGoConfig hasTwitterConfig
    ...
    context 'integration hasXxxConfig booleans' do
      ...
      integrations = {
        ...
        'hasultralutionConfig' => %w[ultraLUTION_API_URL ultraLUTION_ADMIN_SECRET],
        'hasultralutionGoConfig' => %w[ultraLUTION_GO_API_URL ultraLUTION_GO_ADMIN_SECRET],
