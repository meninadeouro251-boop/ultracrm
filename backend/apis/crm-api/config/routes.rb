Rails.application.routes.draw do
  ...
  if ActiveModel::Type::Boolean.new.cast(ENV.fetch('ULTRA_API_ONLY_SERVER', false))
    root to: 'api#index'
  else
    ...
    namespace :v1 do
      ...
      resources :webhooks, only: [:index, :create, :update, :destroy], controller: 'webhooks' do
        ...
        collection do
          ...
          post 'whatsapp/ultralution', to: 'webhooks/whatsapp#process_payload'
          post 'whatsapp/ultralution_go', to: 'webhooks/whatsapp#process_ultralution_go_payload'
          post 'whatsapp/zapi', to: 'webhooks/whatsapp#process_payload'

          # Baileys direct webhook (NestJS service)
          post 'baileys', to: 'webhooks/baileys#webhook'
          post 'baileys/status', to: 'webhooks/baileys#webhook'
      ...
      scope path: 'ultra', as: 'ultra' do
        resource :authorization, only: [:create], controller: 'ultra/authorizations'
        resources :qrcodes, only: [:create, :show], controller: 'ultra/qrcodes'
        resources :proxies, only: [:create, :show], controller: 'ultra/proxies'
        resources :settings, only: [:create, :show, :update], controller: 'ultra/settings'
        resources :privacy, only: [:show, :update], controller: 'ultra/privacy'
        resources :instances, only: [:index], controller: 'ultra/instances' do
          member do
            delete :logout
          end
        end
        post 'profile/:instance_name/fetch', to: 'ultra/profile#fetch', as: :profile_fetch
        post 'profile/:instance_name/name', to: 'ultra/profile#update_name', as: :profile_update_name
        post 'profile/:instance_name/status', to: 'ultra/profile#update_status', as: :profile_update_status
        post 'profile/:instance_name/picture', to: 'ultra/profile#update_picture', as: :profile_update_picture
        delete 'profile/:instance_name/picture', to: 'ultra/profile#remove_picture', as: :profile_remove_picture
      end

      scope path: 'ultra_go', as: 'ultra_go' do
        resource :authorization, only: [:create], controller: 'ultra_go/authorizations' do
          collection do
            post :connect
            get :qrcode
            get :fetch
        ...
        resources :settings, only: [:show, :update], controller: 'ultra_go/settings'
        resources :qrcodes, only: [:show, :create], controller: 'ultra_go/qrcodes'
        resources :privacy, only: [:show, :update], controller: 'ultra_go/privacy'
        post 'profile/info', to: 'ultra_go/profile#info', as: :profile_info
        post 'profile/avatar', to: 'ultra_go/profile#avatar', as: :profile_avatar
        post 'profile/picture', to: 'ultra_go/profile#update_picture', as: :profile_update_picture
        get 'profile/:id', to: 'ultra_go/profile#show', as: :profile_show
        post 'profile/:id/name', to: 'ultra_go/profile#update_name', as: :profile_update_name
        post 'profile/:id/status', to: 'ultra_go/profile#update_status', as: :profile_update_status
        post 'profile/:id/picture', to: 'ultra_go/profile#update_picture_by_instance', as: :profile_update_picture_by_instance
        delete 'profile/:id/picture', to: 'ultra_go/profile#remove_picture', as: :profile_remove_picture
      end
  ...
  post 'webhooks/whatsapp/ultralution', to: 'webhooks/whatsapp#process_payload'
  post 'webhooks/whatsapp/ultralution_go', to: 'webhooks/whatsapp#process_ultralution_go_payload'
  post 'webhooks/whatsapp/zapi', to: 'webhooks/whatsapp#process_payload'
  post 'webhooks/baileys', to: 'webhooks/baileys#webhook'
  post 'webhooks/baileys/status', to: 'webhooks/baileys#webhook'
