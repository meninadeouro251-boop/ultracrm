class Crm::Bms::Mappers::CustomAttributeMapper
  ...
  def map_attribute_type
    # Map ultralution attribute types to BMS custom field types
  ...
  def build_description
    # Create a description based on the ultralution attribute
    description_parts = []

    # Add the attribute key for reference
    description_parts << "ultralution attribute: #{custom_attribute_definition.attribute_key}"
