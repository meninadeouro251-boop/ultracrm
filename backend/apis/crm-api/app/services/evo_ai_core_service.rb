...
class ultraAiCoreService
  ...
  class << self
    ...
    def list_agents(params = {}, request_headers = nil)
      ...
      Rails.logger.info "ultraAiCoreService.list_agents - Response code: #{response.code}, Body: #{response.body[0..500]}"
    ...
    def sync_ultralution_bot(agent_id, request_headers = nil)
