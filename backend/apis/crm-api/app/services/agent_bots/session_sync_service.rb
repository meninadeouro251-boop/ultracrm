module AgentBots
  class SessionSyncService
    ...
    def build_session_id
      ...
      # Uses the agent_id from outgoing_url (ultra-core-service agent ID)
    ...
    def make_request(method, endpoint, body = nil, headers: nil)
      base_url = ENV.fetch('ULTRA_AI_PROCESSOR_URL', 'http://localhost:8000')
    ...
    def build_session_metadata
      ...
      {
        ultra_crm_event: 'conversation.created',
        ultra_crm_data: {
