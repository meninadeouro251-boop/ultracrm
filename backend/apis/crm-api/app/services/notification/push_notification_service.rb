class Notification::PushNotificationService
  ...
  def perform
    ...
    notification_subscriptions.each do |subscription|
      ...
      send_push_via_ultralution_hub(subscription)
    end
  end
  ...
  def send_push_via_ultralution_hub(subscription)
    return if firebase_credentials_present?
    return unless ultralution_hub_enabled?
    return unless subscription.fcm?

    ultralutionHub.send_push(fcm_options(subscription))
  end
