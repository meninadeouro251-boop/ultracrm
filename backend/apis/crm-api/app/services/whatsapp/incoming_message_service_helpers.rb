module Whatsapp::IncomingMessageServiceHelpers
  ...
  def message_type
    if ultra_api?
      # Ultra API structure: data.messageType
  ...
  def message_content(message)
    # TODO: map interactive messages back to button messages in ultralution
  ...
  # ref: https://github.com/ultralution/ultralution/issues/5840
  ...
  def processed_waid(waid)
    ...
    # https://github.com/ultralution/ultralution/issues/5840
  ...
  def message_under_process?
    message_id = if ultra_api?
                   # Ultra API structure: data.key.id
  ...
  def ultra_api?
    # Ultra API has data structure with event field, while Baileys has messages array
