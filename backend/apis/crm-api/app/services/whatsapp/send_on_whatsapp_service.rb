class Whatsapp::SendOnWhatsappService < Base::SendOnChannelService
  ...
  def send_template_message
    ...
    # Use contact identifier if available (for ultralution Go SenderAlt), otherwise fallback to source_id
  ...
  def determine_target_number_for_sending
    ...
    # For ultralution Go provider, identifier prioritizes over phone_number
    elsif channel.provider == 'ultralution_go'
