module Whatsapp::ultralutionHandlers::Helpers
  ...
  def incoming?
    ...
    if @raw_message[:fromMe].present?
      ...
      Rails.logger.warn 'Ultra API: Unable to determine message direction, assuming incoming'
      true
    end
  end
  ...
  def phone_number_from_jid
    # Ultra API format: "5511999999999@s.whatsapp.net" or "5511999999999@c.us"
  ...
  def jid_type
    ...
    # Based on Ultra API JID patterns
    case server
