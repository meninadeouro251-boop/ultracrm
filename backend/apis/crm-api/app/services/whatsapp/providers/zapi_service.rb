class Whatsapp::Providers::ZapiService < Whatsapp::Providers::BaseService
  ...
  def validate_provider_config?
    ...
    # Similar to ultralution Go, we don't make API calls during validation
  ...
  def callback_url
    ...
    # Priority: BACKEND_URL > ULTRA_URL > FRONTEND_URL
    api_url = ENV.fetch('BACKEND_URL', ENV.fetch('ULTRA_URL', ENV.fetch('FRONTEND_URL', 'https://api.ultraai.app')))
