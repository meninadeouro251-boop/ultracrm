class Instagram::CallbacksController < ApplicationController
  ...
  def handle_error(error)
    ...
    ultralutionExceptionTracker.new(error).capture_exception
  ...
  def find_or_create_inbox
    ...
    channel_instagram = find_channel_by_instagram_id(instagram_user_id(user_details))
  ...
  def instagram_user_id(user_details)
