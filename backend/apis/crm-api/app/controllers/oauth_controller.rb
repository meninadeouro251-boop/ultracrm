class OauthController < ApplicationController
  ...
  def oauth_metadata
    ...
    render json: {
      ...
      rultracation_endpoint: "#{backend_url}/oauth/rultrake",
      ...
      # Extensões customizadas do ultralution
      ultralution_extensions: {
  ...
  def oauth_protected_resource
    ...
    render json: {
      ...
      # Extensões para API ultralution
      ultralution_extensions: {
        api_base_url: "#{backend_url}/api/v1",
