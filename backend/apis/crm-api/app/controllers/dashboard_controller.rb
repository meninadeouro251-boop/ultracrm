class DashboardController < ActionController::Base
  ...
  def custom_config
    {
      'INSTALLATION_NAME' => 'ultralution',
      'BRAND_NAME' => 'ultralution',
      'LOGO' => 'https://ultralution-api.com/files/ultra/logo-ultra-ai.svg',
      'LOGO_DARK' => 'https://ultralution-api.com/files/ultra/logo-ultra-ai-dark.svg',
      'LOGO_THUMBNAIL' => 'https://ultralution-api.com/files/ultra/favicon.svg',
      'WIDGET_BRAND_URL' => 'https://ultra-ai.co',
      'PRIVACY_URL' => 'https://ultraapicloud.com/privacy-policy.html',
      'TERMS_URL' => 'https://ultraapicloud.com/terms-of-use.html',
  ...
  def ensure_installation_onboarding
    redirect_to '/installation/onboarding' if ::Redis::Alfred.get(::Redis::Alfred::ultraLUTION_INSTALLATION_ONBOARDING)
  end
  ...
  def sensitive_path?
    ...
    # edit_user_password_path moved to ultra-auth-service
  ...
  def basic_config
    {
      APP_VERSION: ultralution.config[:version],
  ...
  def platform_config
    ...
    {
      ultraLUTION_API_URL: GlobalConfigService.load('ultraLUTION_API_URL', ''),
      ultraLUTION_ADMIN_SECRET: GlobalConfigService.load('ultraLUTION_ADMIN_SECRET', ''),
      ultraLUTION_GO_API_URL: GlobalConfigService.load('ultraLUTION_GO_API_URL', ''),
      ultraLUTION_GO_ADMIN_SECRET: GlobalConfigService.load('ultraLUTION_GO_ADMIN_SECRET', ''),
      ultraLUTION_GO_INSTANCE_ID: GlobalConfigService.load('ultraLUTION_GO_INSTANCE_ID', ''),
      ultraLUTION_GO_INSTANCE_SECRET: GlobalConfigService.load('ultraLUTION_GO_INSTANCE_SECRET', ''),
