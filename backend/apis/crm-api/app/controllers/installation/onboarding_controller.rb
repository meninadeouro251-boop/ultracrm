class Installation::OnboardingController < ApplicationController
  ...
  def finish_onboarding
    ::Redis::Alfred.delete(::Redis::Alfred::ultraLUTION_INSTALLATION_ONBOARDING)
    return if onboarding_params[:subscribe_to_updates].blank?

    ultralutionHub.register_instance(
  ...
  def ensure_installation_onboarding
    redirect_to '/' unless ::Redis::Alfred.get(::Redis::Alfred::ultraLUTION_INSTALLATION_ONBOARDING)
  end
end
