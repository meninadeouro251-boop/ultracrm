    ...
    module Admin
      class AppConfigsController < BaseController
        CONFIG_TYPES = {
          ...
          'ultralution' => %w[ultraLUTION_API_URL ultraLUTION_ADMIN_SECRET],
          'ultralution_go' => %w[ultraLUTION_GO_API_URL ultraLUTION_GO_ADMIN_SECRET
                               ultraLUTION_GO_INSTANCE_ID ultraLUTION_GO_INSTANCE_SECRET],
          'openai' => %w[
