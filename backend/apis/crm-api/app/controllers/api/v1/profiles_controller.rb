class Api::V1::ProfilesController < Api::BaseController
  ...
  def update
    # Password update moved to ultra-auth-service
  ...
  # def resend_confirmation - moved to ultra-auth-service

  # def reset_access_token - moved to ultra-auth-service
  ...
  # def password_params - moved to ultra-auth-service
end
