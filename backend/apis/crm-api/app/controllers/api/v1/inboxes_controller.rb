  ...
  module V1
      class InboxesController < Api::V1::BaseController
        ...
        def create_channel
          ...
          # Debug logs for ultralution Go channel creation
          if permitted_params[:channel][:type] == 'whatsapp' && permitted_params[:channel][:provider] == 'ultralution_go'
            Rails.logger.info "Creating ultralution Go channel with params: #{permitted_params[:channel].inspect}"
          end
        ...
        def permitted_params(channel_attributes = [])
          # We will remove this line after fixing https://linear.app/ultralution/issue/CW-1567/null-value-passed-as-null-string-to-backend
