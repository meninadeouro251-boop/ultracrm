class Api::BaseController < ApplicationController
  ...
  include ultraPermissionConcern
  ...
  def authenticate_request!
    ...
    if service_token_present?
      ...
      # Extract Bearer token and pass to ultraAuth
      bearer_token = request.headers['Authorization']&.sub(/^Bearer /, '')
      authenticate_user_with_ultra_auth(bearer_token, 'bearer')
    elsif api_access_token_present?
      # Extract api_access_token and pass to ultraAuth
      ...
      authenticate_user_with_ultra_auth(api_token, 'api_access_token')
