...
class Channel::Whatsapp < ApplicationRecord
  ...
  PROVIDERS = %w[default whatsapp_cloud baileys ultra ultra_go notificame zapi].freeze
  ...
  before_destroy :disconnect_channel_provider, if: -> { provider.in?(%w[baileys ultra ultra_go]) }
  ...
  def provider_service
    ...
    when 'ultra'
      Whatsapp::Providers::UltraService.new(whatsapp_channel: self)
    when 'ultra_go'
      Whatsapp::Providers::UltraGoService.new(whatsapp_channel: self)
    when 'notificame'
