# NOTE: See https://github.com/fazer-ai/ultralution/blob/main/CUSTOM_BRANDING.md for more details.
namespace :branding do
  ...
  task update: :environment do
    configurable_items = {
      ...
      'BRAND_URL' => 'https://www.ultralution-api.com',
      # The URL that would be used in the widget under the section “Powered By”
      'WIDGET_BRAND_URL' => 'https://www.ultralution-api.com',
      ...
      'TERMS_URL' => 'https://www.ultralution.com/terms-of-service',
      # The privacy policy URL displayed in the app
      'PRIVACY_URL' => 'https://www.ultralution.com/privacy-policy',
      # Display default ultralution metadata like favicons and upgrade warnings
