...
class Integrations::Facebook::MessageCreator
  ...
  def agent_message_via_echo?
    # TODO : check and remove send_from_ultralution_app if not working
    response.echo? && !response.sent_from_ultralution_app?
    # this means that it is an agent message from page, but not sent from ultralution.
