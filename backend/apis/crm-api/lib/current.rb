module Current
  ...
  thread_mattr_accessor :ultra_auth_validation_cache
  thread_mattr_accessor :ultra_permission_cache
  thread_mattr_accessor :ultra_role_key
  ...
  def self.reset
    ...
    Current.ultra_auth_validation_cache = nil
    Current.ultra_permission_cache = nil
    Current.ultra_role_key = nil
  end
end
