...
# Use the ultralution_prepare task from Makefile which handles everything
bundle exec rails db:ultralution_prepare 2>/dev/null || echo "Database preparation completed (or already prepared)"
